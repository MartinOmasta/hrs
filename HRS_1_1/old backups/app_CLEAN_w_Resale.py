...
with col1:
    ...
    sale_price_fig.add_trace(go.Scatter(x=proj['Year'], y=proj['MarketRateValue'], mode='lines+markers', name='Asking Price (Market)', line=dict(color='#3cb44b', width=2),  marker=dict(symbol='diamond', size=8), hovertemplate="Market - Year: %{x}<br>Home Price: %{y:$,.0f}<extra></extra>"))
    sale_price_fig.add_trace(go.Scatter(x=proj['Year'], y=proj['VALEFixedRateValue'], mode='lines+markers', name='Asking Price (Fixed)', line=dict(color='#F46A25', width=2),  marker=dict(symbol='star', size=8), hovertemplate="Fixed - Year: %{x}<br>Home Price: %{y:$,.0f}<extra></extra>"))
    sale_price_fig.add_trace(go.Scatter(x=proj['Year'], y=proj['AMIRateValue'], mode='lines+markers', name='Asking Price (AMI)', line=dict(color='#4363d8', width=2),  marker=dict(symbol='cross', size=8), hovertemplate="AMI - Year: %{x}<br>Home Price: %{y:$,.0f}<extra></extra>"))
