...
with col1:
    ...
    sale_price_fig.update_layout(
        ...
        yaxis=dict(autorange=True), # Automatically rescale Y-axis when lines are toggled off
        legend=dict(
            ...
            itemclick="toggle",          # Single-click toggles trace visibility on/off
