...
def compute_projections(
    ...
    print(f'Initial: {initial_affordable_purchase_price}')
    print(f'Fixed Value: {initial_vale_fixed_rate_value}')
    ...
    print(f'Balance: {initial_balance_per_period_affordable}')
    # ------------------------------------------------
    ...
    resale_net_wealth_built_fixed = (
        initial_vale_fixed_rate_value 
        - resale_cumulative_mortgage_payments_affordable 
        #- resale_cumulative_property_tax_fixed 
        #- resale_cumulative_insurance 
        - resale_cumulative_hoa 
        - resale_cumulative_ground_lease 
        #- initial_buyer_cash_contribution_downpayment
        - (initial_mortgage_affordable_closing_costs / 2)
        - (resale_selling_costs_fixed / 2)
        - initial_balance_per_period_affordable
    )
    print(f'Mortgage Pay: {resale_cumulative_mortgage_payments_affordable}')

    resale_net_wealth_built_ami = (
        initial_ami_rate_value 
        - resale_cumulative_mortgage_payments_affordable 
        ...
        - resale_cumulative_ground_lease 
        - initial_buyer_cash_contribution_downpayment
        - initial_mortgage_affordable_closing_costs
        - resale_selling_costs_ami 
        - initial_balance_per_period_affordable
    )

    resale_net_wealth_built_market = (
        initial_market_rate_value 
        - resale_cumulative_mortgage_payments_market 
        - resale_cumulative_property_tax_market 
        - resale_cumulative_insurance 
        - resale_cumulative_hoa 
        #- resale_cumulative_ground_lease 
        - initial_downpayment_amount_market
        - initial_mortgage_market_closing_costs
        - resale_selling_costs_market 
        - initial_balance_per_period_market
    )
